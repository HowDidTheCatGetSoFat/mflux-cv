...
def test_sample_does_not_disturb_the_global_rng_stream():
    # The sampler must thread explicit keys: reseeding the global RNG would make
    # PiD-decoding image n change the noise the base diffusion loop draws for
    # image n+1 in a multi-seed run.
